                            ...
                            <div class="booking-outer-wrapper clearfix">
                                ...
                                <div class="select-hotel-wrapper clearfix">
                                    <div class="slt-ht-outerWrapp">
                                        <div class="olive-ht-wrapp">
                                            <div class="olive-ht-img">
                                                <a href="<?= site_url() ?>booking/submit_booking/1"><img src="<?= base_url() ?>images/img-1.jpg" alt="Olive Hotels"></a>
                                            </div>
                                            <div class="olive-ht-content clearfix">
                                                <div class="logo-wrapp">
                                                    <a href="<?= site_url() ?>booking/submit_booking/1"><img src="<?= base_url() ?>images/eva.png" alt="Olive eva"></a>                                </div>
                                                <div class="oline-ht-content">
                                                    ...
                                                    <a href="<?= site_url() ?>booking/submit_booking/1">Select &amp; Continue</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="slt-ht-outerWrapp mrg-right">
                                        <div class="olive-ht-wrapp">
                                            <div class="olive-ht-img">
                                                <a href="<?= site_url() ?>booking/submit_booking/2"><img src="<?= base_url() ?>images/img-2.jpg" alt="Olive Hotels"></a>
                                            </div>
                                            <div class="olive-ht-content clearfix">
                                                <div class="logo-wrapp">
                                                    <a href="<?= site_url() ?>booking/submit_booking/2"><img src="<?= base_url() ?>images/down-town.jpg" alt="Olive eva"></a>                                </div>
                                                <div class="oline-ht-content down-town-content">
                                                    ...
                                                    <a href="<?= site_url() ?>booking/submit_booking/2">Select &amp; Continue</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
