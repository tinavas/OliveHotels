                        ...
                        <div class="col-md-12">
                            <div class="booking-outer-wrapper slt-Rm-Outer clearfix">
                                ...
                                <div class="select-roomWraper clearfix">
                                  <div class="row" id="select-room-alert" style="display:none;"></div>  
                                    <ul class="clearfix">
                                        <?php
                                        $count = 1;
...
//                                                    
//                                                }
                                                $available_rooms = $rate_plans->Rates[0]['AvailableRooms'];
                                            }
                                        ?>
...
//                                        $available_rooms
                                        ...
                                        if($id==2){
                                            if ($room_type['Id'] == 1) {
                                                $room_category = $this->room_master_model->room_details(1,$id);
                                            } else if ($room_type['Id'] == 2) {
                                                $room_category = $this->room_master_model->room_details(2,$id);
                                            } else if ($room_type['Id'] == 3) {
                                                $room_category = $this->room_master_model->room_details(3,$id);
                                            } else if ($room_type['Id'] == 4) {
                                                $room_category = $this->room_master_model->room_details(4,$id);
                                            }
                                        }else if($id==1){
                                            if ($room_type['Id'] == 1) {
                                                $room_category = $this->room_master_model->room_details(5,$id);
                                            } else if ($room_type['Id'] == 2) {
                                                $room_category = $this->room_master_model->room_details(2,$id);
                                            } else if ($room_type['Id'] == 3) {
                                                $room_category = $this->room_master_model->room_details(6,$id);
                                            } else if ($room_type['Id'] == 4) {
                                                $room_category = $this->room_master_model->room_details(4,$id);
                                            }
                                        }
                                        ...
                                        <li class="slt-ul-list <?php if($count % 2==0){ echo 'mrg-right';}?>">
                                            <div class="slt-rm-block">
                                                <div class="slt-imgRm">
                                                    <img src="<?= base_url() ?>uploads/room_master/thumb/<?php echo $room_category[0]->image; ?>" alt="<?php echo $room_category[0]->room_type; ?>" style="width:100%;">
                                                </div>
...
//                                                            }
                                                        ...
                                                        <div class="Rm-pl-list">
                                                            <div class="display-inline">
                                                                <!--<h3><?php echo $rate_plans['Name']; ?></h3>-->
