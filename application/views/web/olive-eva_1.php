                                    ...
                                    <div class="room-detail-content">
                                        ...
                                        <div class="rm-dtl-btm-cont clearfix">
                                            ...
                                            <div class="rm-dtl-btm-right">
                                                <a href="<?= site_url() ?>booking/submit_booking/1">Book Now</a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div id="gallery-slider">
                                <div class="gl-slider-list">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="gallery-list-wrapp">
                                                <img src="<?= base_url() ?>images/gall-thumb-3.jpg" alt="gallery">
                                                <a href="<?= base_url() ?>images/gallery-3.jpg" class="gl-popup" data-fancybox-group="gallery">
                                                    <span class="gl-table">
                                        ...
                                        <div class="col-md-3">
                                            <div class="gallery-list-wrapp">
                                                <img src="<?= base_url() ?>images/gall-thumb-4.jpg" alt="gallery">
                                                <a href="<?= base_url() ?>images/gallery-4.jpg" class="gl-popup" data-fancybox-group="gallery">
                                                    <span class="gl-table">
                                                        <span class="gl-table-cell"><i></i></span>
                                                    </span>
                                                </a>
                                        ...
                                        <div class="col-md-3">
                                            <div class="gallery-list-wrapp">
                                                <img src="<?= base_url() ?>images/img-6.jpg" alt="gallery">
                                                <a href="<?= base_url() ?>images/gallery-1.jpg" class="gl-popup" data-fancybox-group="gallery">
                                                    <span class="gl-table">
                                                        <span class="gl-table-cell"><i></i></span>
                                                    </span>
                                                </a>
                                        ...
                                        <div class="col-md-3">
                                            <div class="gallery-list-wrapp">
                                                <img src="<?= base_url() ?>images/gall-thumb-2.jpg" alt="gallery">
                                                <a href="<?= base_url() ?>images/gallery-2.jpg" class="gl-popup" data-fancybox-group="gallery">
                                                    <span class="gl-table">
                                                        <span class="gl-table-cell"><i></i></span>
                                                    </span>
                                                </a>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="gallery-list-wrapp">
                                                <img src="<?= base_url() ?>images/gall-thumb-5.jpg" alt="gallery">
                                                <a href="<?= base_url() ?>images/gallery-5.jpg" class="gl-popup" data-fancybox-group="gallery">
                                                    <span class="gl-table">
                                                        <span class="gl-table-cell"><i></i></span>
                                                    </span>
                                                </a>
                                        ...
                                        <div class="col-md-3">
                                            <div class="gallery-list-wrapp">
                                                <img src="<?= base_url() ?>images/gall-thumb-6.jpg" alt="gallery">
                                                <a href="<?= base_url() ?>images/gallery-6.jpg" class="gl-popup" data-fancybox-group="gallery">
                                                    <span class="gl-table">
                                                        <span class="gl-table-cell"><i></i></span>
                                                    </span>
                                                </a>
                                        ...
                                        <div class="col-md-3">
                                            <div class="gallery-list-wrapp">
                                                <img src="<?= base_url() ?>images/gall-thumb-7.jpg" alt="gallery">
                                                <a href="<?= base_url() ?>images/gallery-7.jpg" class="gl-popup" data-fancybox-group="gallery">
                                                    <span class="gl-table">
                                                        <span class="gl-table-cell"><i></i></span>
                                                    </span>
                                                </a>
                                        ...
                                        <div class="col-md-3">
                                            <div class="gallery-list-wrapp">
                                                <img src="<?= base_url() ?>images/gall-thumb-8.jpg" alt="gallery">
                                                <a href="<?= base_url() ?>images/gallery-8.jpg" class="gl-popup" data-fancybox-group="gallery">
                                                    <span class="gl-table">
                                                        <span class="gl-table-cell"><i></i></span>
                                                    </span>
                                                </a>
                                ...
                                <div class="gl-slider-list">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="gallery-list-wrapp">
                                                <img src="<?= base_url() ?>images/gall-thumb-9.jpg" alt="gallery">
                                                <a href="<?= base_url() ?>images/gallery-9.jpg" class="gl-popup" data-fancybox-group="gallery">
                                                    <span class="gl-table">
                                                        <span class="gl-table-cell"><i></i></span>
                                                    </span>
                                                </a>
                                        ...
                                        <div class="col-md-3">
                                            <div class="gallery-list-wrapp">
                                                <img src="<?= base_url() ?>images/gall-thumb-10.jpg" alt="gallery">
                                                <a href="<?= base_url() ?>images/gallery-10.jpg" class="gl-popup" data-fancybox-group="gallery">
                                                    <span class="gl-table">
                                                        <span class="gl-table-cell"><i></i></span>
                                                    </span>
                                                </a>
                                        ...
                                        <div class="col-md-3">
                                            <div class="gallery-list-wrapp">
                                                <img src="<?= base_url() ?>images/gall-thumb-11.jpg" alt="gallery">
                                                <a href="<?= base_url() ?>images/gallery-11.jpg" class="gl-popup" data-fancybox-group="gallery">
                                                    <span class="gl-table">
                                                        <span class="gl-table-cell"><i></i></span>
                                                    </span>
                                                </a>
                                        ...
                                        <div class="col-md-3">
                                            <div class="gallery-list-wrapp">
                                                <img src="<?= base_url() ?>images/gall-thumb-12.jpg" alt="gallery">
                                                <a href="<?= base_url() ?>images/gallery-12.jpg" class="gl-popup" data-fancybox-group="gallery">
                                                    <span class="gl-table">
                                                        <span class="gl-table-cell"><i></i></span>
                                                    </span>
                                                </a>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="gallery-list-wrapp">
                                                <img src="<?= base_url() ?>images/gall-thumb-13.jpg" alt="gallery">
                                                <a href="<?= base_url() ?>images/gallery-13.jpg" class="gl-popup" data-fancybox-group="gallery">
                                                    <span class="gl-table">
                                                        <span class="gl-table-cell"><i></i></span>
                                                    </span>
                                                </a>
                                        ...
                                        <div class="col-md-3">
                                            <div class="gallery-list-wrapp">
                                                <img src="<?= base_url() ?>images/gall-thumb-14.jpg" alt="gallery">
                                                <a href="<?= base_url() ?>images/gallery-14.jpg" class="gl-popup" data-fancybox-group="gallery">
                                                    <span class="gl-table">
                                                        <span class="gl-table-cell"><i></i></span>
                                                    </span>
                                                </a>
                                        ...
                                        <div class="col-md-3">
                                            <div class="gallery-list-wrapp">
                                                <img src="<?= base_url() ?>images/gall-thumb-15.jpg" alt="gallery">
                                                <a href="<?= base_url() ?>images/gallery-15.jpg" class="gl-popup" data-fancybox-group="gallery">
                                                    <span class="gl-table">
                                                        <span class="gl-table-cell"><i></i></span>
                                                    </span>
                                                </a>
                                        ...
                                        <div class="col-md-3">
                                            <div class="gallery-list-wrapp">
                                                <img src="<?= base_url() ?>images/gall-thumb-16.jpg" alt="gallery">
                                                <a href="<?= base_url() ?>images/gallery-16.jpg" class="gl-popup" data-fancybox-group="gallery">
                                                    <span class="gl-table">
                                                        <span class="gl-table-cell"><i></i></span>
                                                    </span>
                                                </a>
