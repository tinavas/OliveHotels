                                    ...
                                    <div class="HotelBookingWrapper  wow slideInRight" data-wow-duration="1.2s">
                                        ...
                                        <div class="HotelBooking-FormWrapper">
                                            <div class="HTBK-inner clearfix">
                                                ...
                                                <form name="quick_book" action="<?php echo base_url();?>booking/quick_book" method="post">
                                                    ...
                                                    <div class="BK-formGroup BKright-curved">
                                                        <label>Arrival</label>
                                                        <input type="text" id="datepicker" value="<?php echo date('d-m-Y');?>" placeholder="Select arrival date" name="checkin_date"/>
                                                    </div>
                                                    <div class="BK-formGroup BKright-curved">
                                                        <label>Departure</label>
                                                        <input type="text" id="datepicker-1" value="<?php echo date('d-m-Y', strtotime( date('d-m-Y'). ' + 1 day'));?>" placeholder="Select departure date" name="checkout_date"/>
                                                    </div>
...
<script>
    function change_hotel(){
        var action = $('#hotel_master').val();
            ...
            $("#quick_book").attr("action", "<?= base_url()?>booking/booking_landing/" + action);
    }
