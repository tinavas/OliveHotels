...
//
                                        if ($respcode == "AA") {
                                            echo "<br><b>Thank you for booking with us. Your credit card has been charged and your transaction is successful.</b>";

                                            //Here you need to put in the routines for a successful
                                            //transaction such as sending an email to customer,
                                            //setting database status, informing logistics etc etc
                                        } else {
                                            echo "<br><b>Thank you for booking with us. However,the transaction has been declined.</b>";
//
