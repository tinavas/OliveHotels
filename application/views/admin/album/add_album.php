                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-bar-chart-o"></i> Add Album  </h3>                                
                            </div>
                            <div class="panel-body">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <?php echo form_open_multipart('admin/album/add_album/'.$id, array('id' => 'albumForm', 'class' => 'form-horizontal')); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <!--<input name="album_name" type="text" class="form-control" id="album_name" placeholder="Room Name" value="<?php echo set_value('album_name'); ?>">-->
                                    ...
                                    <div class="form-group">
                                        <button name="submit" type="submit" class="btn btn-primary pull-right">Add Album</button>                                            
                                    </div>
        ...
        <script type="text/javascript" >
            $(document).ready(function() {
                ...
                $('#albumForm').submit(function() {
                    ...
                    if ($('#album_name').val() == "") {
                        $('#album_name').focus();
                        $('#album_name_err').text("Please provide a room name").fadeIn(300).delay(3000).fadeOut(800);
                        return false;
