                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li> <a href="<?php echo base_url(); ?>admin/room_master/room_availability_season/<?php echo $room_availability_season->room_master_id; ?>">Room Availability for Season</a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                ...
                                <?php } ?> 
                                <div class="col-lg-6">
                                    <form class="form-horizontal" id="room_masterForm" role="form" action="<?php echo base_url(); ?>admin/room_master/edit_room_availability_season/<?php echo $room_availability_season->room_master_id; ?>/<?php echo $room_availability_season->room_availability_season_id; ?>" method="post" enctype="multipart/form-data">

                                        <div class="form-group">
                                            <label for="from_date" class="col-sm-3 control-label">From date</label>
                                            <div class="col-sm-9">
                                                <input name="from_date" type="text" class="form-control" id="from_date" value="<?php echo $room_availability_season->from_date; ?>" placeholder="From Date">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input name="to_date" type="text" class="form-control" id="to_date" value="<?php echo $room_availability_season->to_date; ?>" placeholder="To Date">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input name="rate" type="text" class="form-control" id="rate" value="<?php echo $room_availability_season->rate; ?>" placeholder="Rate - Single Occupancy">
                                                <span class="errs"><?php echo form_error('rate'); ?></span>
                                            </div>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="rate" class="col-sm-3 control-label">Rate - Double Occupancy</label>
                                            <div class="col-sm-9">
                                                <input name="rate_double" type="text" class="form-control" id="rate" value="<?php echo $room_availability_season->rate_double; ?>" placeholder="Rate - Single Occupancy">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input name="rate_extra_bed" type="text" class="form-control" id="rate_extra_bed" value="<?php echo $room_availability_season->rate_extra_bed; ?>" placeholder="Extra Bed Rate">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input name="availability" type="text" class="form-control" id="availability" value="<?php echo $room_availability_season->availability; ?>" placeholder="Availability">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input name="priority" type="text" class="form-control" id="priority" value="<?php echo $room_availability_season->priority; ?>" placeholder="Priority">
                                        ...
                                        <div class="form-group">
                                            <button name="submit" type="submit" class="btn btn-primary pull-right">Update Room Availability</button>                                            
                                        </div>
