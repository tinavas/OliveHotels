                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    <div class="col col-sm-6">
                                        <h3 class="panel-title"><i class="fa fa-bar-chart-o"></i> Newsletter Subscribers </h3> 
                                    </div>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($newsletter as $c => $list) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url(); ?>admin/newsletter/delete/<?php echo $list->id; ?>" onclick="return confirm('Do you want to delete this record ?');">Delete</a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
