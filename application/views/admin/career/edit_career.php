...
<html lang="en">
                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <?php echo form_open_multipart('admin/career/edit/'.$career_id, array('id' => 'careerForm', 'class' => 'form-horizontal')); ?>

         
                                    <div class="form-group">
                                        <label for="career_title" class="col-sm-3 control-label">Job  Title</label>
                                        <div class="col-sm-9">
                                            <input name="career_title" type="text" class="form-control" id="career_title"  value="<?=$career[0]["career_title"]?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input name="career_no" type="text" class="form-control"   size="45" value="<?=$career[0]["career_no"]?>">
  ...
  <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input name="career_location" type="text" class="form-control"   size="45" value="<?=$career[0]["career_location"]?>">
                                   ...
                                   <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input name="career_education" type="text" class="form-control"   size="45" value="<?=$career[0]["career_education"]?>">
                                        ...
                                        <div class="col-sm-9">
                                            <input name="career_experience" type="text" class="form-control"   size="45" value="<?=$career[0]["career_experience"]?>">
                                        ...
                                        <div class="col-sm-9">
                                            <input name="career_salary" type="text" class="form-control"   size="45" value="<?=$career[0]["career_salary"]?>">
                                        ...
                                        <div class="col-sm-9">
                                            <input name="career_candidature" type="text" class="form-control"   size="45" value="<?=$career[0]["career_candidature"]?>">
