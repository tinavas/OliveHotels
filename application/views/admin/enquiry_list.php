                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    <div class="col col-sm-6">
                                        <h3 class="panel-title"><i class="fa fa-bar-chart-o"></i> Enquiry List  </h3> 
                                    </div>
                                    ...
                                    <table class="table table-hover tablesorter">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="header" width="10%">Hotel Name <i class="fa fa-sort"></i></th>
                                                ...
                                                <th class="header" width="20%">Message <i class="fa fa-sort"></i></th>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($enquirys as $c => $enquiry) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url(); ?>admin/enquiry/delete_enquiry/<?php echo $enquiry->enquiry_id; ?>" onclick="return confirm('Do you want to delete this record ?');">Delete</a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
